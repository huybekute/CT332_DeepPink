...
try:
    background_raw = pygame.image.load("background/background2.png")
except pygame.error:
    background_raw = None

chessboard_image_raw = pygame.image.load("background/banco.png")
wood_texture_raw = pygame.image.load("textures/soil.jpg")
white_texture_raw = pygame.image.load("textures/snow.jpg")
    ...
    for row in range(8):
        for col in range(8):
            ...
            if piece:
                ...
                if color == "white":
                    if piece == "P": scale_ratio *= 0.7
                    elif piece == "K" or piece =="Q": scale_ratio *= 0.85
                    else: scale_ratio *=0.75
                else:
                    if piece == "K": scale_ratio *= 0.9
                    else: scale_ratio *= 0.85
