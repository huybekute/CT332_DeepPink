...
try:
    background_raw = pygame.image.load("background/background0.jpg")
except pygame.error:
    background_raw = None

chessboard_image_raw = pygame.image.load("background/banco.png")
wood_texture_raw = pygame.image.load("textures/wood.jpg")
white_texture_raw = pygame.image.load("textures/white.jpg")
    ...
    for row in range(8):
        for col in range(8):
            ...
            if piece:
                ...
                if color == "white":
                    if piece == "P": scale_ratio *= 1.1
                    elif piece in ["K", "Q"]: scale_ratio *= 0.9
                else:
